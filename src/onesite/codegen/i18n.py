...
def generate_locale_files(
    ...
    en_translations: Dict[str, Any] = {
        ...
        "video_stream": {
            ...
            "rtsp_converting": "Connecting to the RTSP source and preparing HLS preview...",
            "rtsp_gateway_error": "RTSP preview is unavailable. Check the media gateway, source allowlist, credentials, and camera connectivity.",
    ...
    zh_translations: Dict[str, Any] = {
        ...
        "video_stream": {
            ...
            "detected": "识别类型：{{type}}",
            "loading": "正在连接视频流……",
            "rtsp_converting": "正在连接 RTSP 视频源并准备 HLS 预览……",
            "rtsp_gateway_error": "RTSP 预览不可用，请检查媒体网关、源地址白名单、凭据和摄像头连接。",
            "empty": "暂无视频流地址",
